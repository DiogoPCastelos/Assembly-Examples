...
output: .asciz "The result of the multiplication is: %ld\n" #same here
...
main:
    ...
    mov number1, %rax #move the value of number1 to register rax
    mul %rsi #multiply value of rax with value of rsi (number2)
